...
- **Background:** `#1e2122` · **Surface:** `#2d3436` · **Accent:** `#d4af37`
- **Font:** [Outfit](https://fonts.google.com/specimen/Outfit) (weights 300, 400, 600)
- Centered modal layout, gold top-border, subtle shadow
